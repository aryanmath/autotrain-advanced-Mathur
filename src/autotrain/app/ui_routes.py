...
async def create_project(
    ...
    try:
        ...
        if task == "automatic-speech-recognition":
            params = PARAMS["automatic-speech-recognition"]
        elif task == "text-classification":
            params = PARAMS["text-classification"]
        elif task == "token-classification":
            params = PARAMS["token-classification"]
        elif task == "question-answering":
            params = PARAMS["question-answering"]
        elif task == "summarization":
            params = PARAMS["summarization"]
        elif task == "translation":
            params = PARAMS["translation"]
        elif task == "text-generation":
            params = PARAMS["text-generation"]
        elif task == "image-classification":
            params = PARAMS["image-classification"]
        elif task == "image-regression":
            params = PARAMS["image-regression"]
        elif task == "tabular-classification":
            params = PARAMS["tabular-classification"]
        elif task == "tabular-regression":
            params = PARAMS["tabular-regression"]
        ...
        if task == "automatic-speech-recognition":
            preprocessor = AutomaticSpeechRecognitionPreprocessor(
                ...
                username=token,
                column_mapping=column_mapping,
                valid_data=valid_split if valid_split else None,
            )
        elif task == "text-classification":
            ...
            preprocessor = TabularClassificationPreprocessor(
                train_data=data_path,
                token=token,
                project_name=project_name,
                username=token,
            ...
            preprocessor = TabularRegressionPreprocessor(
                train_data=data_path,
                token=token,
                project_name=project_name,
                username=token,
